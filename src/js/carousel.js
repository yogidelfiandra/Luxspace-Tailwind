...
function carouselCalculateOffset() {
  ...
  carouselItems.style.paddingLeft = `${carouselOffset - 20}px`;
  carouselItems.style.paddingRight = `${carouselOffset - 20}px`;
}

function slide(wrapper, items) {
  let posX1 = 0, posX2 = 0, posInitial, posFinal, threshold = 100,
  itemToShow = 4, slides = items.getElementsByClassName("card"), slidesLength = slides.length, slideSize = items.getElementsByClassName("card") [0].offsetWidth,
